...
#+begin_src emacs-lisp
(let* ((variable-tuple
         (cond ((x-list-fonts "JetBrainsMono NF")  '(:font "JetBrainsMono NF"))
      ...
      (custom-theme-set-faces
       ...
       `(org-level-4        ((t (:inherit outline-4 ,@variable-tuple :height 1.0  :weight semi-bold))))
       `(org-level-3        ((t (:inherit outline-3 ,@variable-tuple :height 1.05  :weight semi-bold))))
       `(org-level-2        ((t (:inherit outline-2 ,@variable-tuple :height 1.10 :weight semi-bold))))
       `(org-level-1        ((t (:inherit outline-1 ,@variable-tuple :height 1.15  :weight semi-bold))))
       `(org-document-title ((t (:inherit default   ,@variable-tuple :height 1.25 :weight semi-bold :foreground "sky blue"))))))
#+end_src
